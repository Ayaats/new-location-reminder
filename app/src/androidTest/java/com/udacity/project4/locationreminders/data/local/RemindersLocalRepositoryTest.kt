...
class RemindersLocalRepositoryTest {
    ...
    @Test
    fun givenRemindersInDb_getReminderById_returnsCorrectReminder() =runBlocking {
        // Given
    ...
    @Test
    fun givenEmptyDb_getReminderById_returnsReminderNotFoundError() = runBlocking {
    ...
    @Test
    fun givenRemindersInDb_deleteAllReminders_deletesRemindersInDb() =runBlocking {
        // GIVEN
        val r1 = ReminderDTO("t1", "d1", "l1",
            0.0, 0.0)
